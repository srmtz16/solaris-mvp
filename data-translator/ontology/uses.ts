export const usesByField: Record<string, string[]> = {
  ...
  voltage_max: ["Validacion de limites", "Alertas", "Calidad electrica"],
  voltage_min: ["Validacion de limites", "Alertas", "Calidad electrica"],
  power_max: ["Analisis de clipping", "Validacion de capacidad", "Reportes"],
